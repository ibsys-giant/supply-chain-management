...
namespace SupplyChainManagement
{
    public class DataSourceMock : DataSource
    {
        ...
        public DataSourceMock()
        {
            ...
            // 1
            Items[1].ItemQuantities.Add(Items[21], 1);
            Items[1].ItemQuantities.Add(Items[24], 1);
            Items[1].ItemQuantities.Add(Items[27], 1);
            Items[1].ItemQuantities.Add(Items[26], 1);
            Items[1].ItemQuantities.Add(Items[51], 1);

            // 2
            Items[2].ItemQuantities.Add(Items[22], 1);
            Items[2].ItemQuantities.Add(Items[24], 1);
            Items[2].ItemQuantities.Add(Items[27], 1);
            Items[2].ItemQuantities.Add(Items[26], 1);
            Items[2].ItemQuantities.Add(Items[56], 1);

            // 3
            Items[3].ItemQuantities.Add(Items[23], 1);
            Items[3].ItemQuantities.Add(Items[24], 1);
            Items[3].ItemQuantities.Add(Items[27], 1);
            Items[3].ItemQuantities.Add(Items[26], 1);
            Items[3].ItemQuantities.Add(Items[31], 1);

            // 4
            Items[4].ItemQuantities.Add(Items[35], 2);
            Items[4].ItemQuantities.Add(Items[36], 1);
            Items[4].ItemQuantities.Add(Items[52], 1);
            Items[4].ItemQuantities.Add(Items[53], 36);

            // 5
            Items[5].ItemQuantities.Add(Items[35], 2);
            Items[5].ItemQuantities.Add(Items[36], 1);
            Items[5].ItemQuantities.Add(Items[57], 1);
            Items[5].ItemQuantities.Add(Items[58], 36);

            // 6
            Items[6].ItemQuantities.Add(Items[33], 1);
            Items[6].ItemQuantities.Add(Items[34], 36);
            Items[6].ItemQuantities.Add(Items[35], 2);
            Items[6].ItemQuantities.Add(Items[36], 1);

            // 7
            Items[7].ItemQuantities.Add(Items[35], 2);
            Items[7].ItemQuantities.Add(Items[37], 1);
            Items[7].ItemQuantities.Add(Items[38], 1);
            Items[7].ItemQuantities.Add(Items[52], 1);
            Items[7].ItemQuantities.Add(Items[53], 36);

            // 8
            Items[8].ItemQuantities.Add(Items[35], 2);
            Items[8].ItemQuantities.Add(Items[37], 1);
            Items[8].ItemQuantities.Add(Items[38], 1);
            Items[8].ItemQuantities.Add(Items[57], 1);
            Items[8].ItemQuantities.Add(Items[58], 36);

            // 9
            Items[9].ItemQuantities.Add(Items[33], 1);
            Items[9].ItemQuantities.Add(Items[34], 36);
            Items[9].ItemQuantities.Add(Items[35], 2);
            Items[9].ItemQuantities.Add(Items[37], 1);
            Items[9].ItemQuantities.Add(Items[38], 1);

            // 10
            Items[10].ItemQuantities.Add(Items[32], 1);
            Items[10].ItemQuantities.Add(Items[39], 1);

            // 11
            Items[11].ItemQuantities.Add(Items[32], 1);
            Items[11].ItemQuantities.Add(Items[39], 1);

            // 12
            Items[12].ItemQuantities.Add(Items[32], 1);
            Items[12].ItemQuantities.Add(Items[39], 1);

            // 13
            Items[13].ItemQuantities.Add(Items[32], 1);
            Items[13].ItemQuantities.Add(Items[39], 1);

            // 14
            Items[14].ItemQuantities.Add(Items[32], 1);
            Items[14].ItemQuantities.Add(Items[39], 1);

            // 15
            Items[15].ItemQuantities.Add(Items[32], 1);
            Items[15].ItemQuantities.Add(Items[39], 1);

            // 16
            Items[16].ItemQuantities.Add(Items[24], 1);
            Items[16].ItemQuantities.Add(Items[28], 1);
            Items[16].ItemQuantities.Add(Items[40], 1);
            Items[16].ItemQuantities.Add(Items[41], 1);
            Items[16].ItemQuantities.Add(Items[42], 2);

            // 17
            Items[17].ItemQuantities.Add(Items[43], 1);
            Items[17].ItemQuantities.Add(Items[44], 1);
            Items[17].ItemQuantities.Add(Items[45], 1);
            Items[17].ItemQuantities.Add(Items[46], 1);

            // 18
            Items[18].ItemQuantities.Add(Items[28], 3);
            Items[18].ItemQuantities.Add(Items[32], 1);
            Items[18].ItemQuantities.Add(Items[59], 2);

            // 19
            Items[19].ItemQuantities.Add(Items[28], 4);
            Items[19].ItemQuantities.Add(Items[32], 1);
            Items[19].ItemQuantities.Add(Items[59], 2);

            // 20
            Items[20].ItemQuantities.Add(Items[28], 5);
            Items[20].ItemQuantities.Add(Items[32], 1);
            Items[20].ItemQuantities.Add(Items[59], 2);

            // 21-25: Procurement parts

            // 26
            Items[26].ItemQuantities.Add(Items[44], 2);
            Items[26].ItemQuantities.Add(Items[47], 1);
            Items[26].ItemQuantities.Add(Items[48], 2);

            // 27-28: Procurement parts

            // 29
            Items[29].ItemQuantities.Add(Items[24], 2);
            Items[29].ItemQuantities.Add(Items[25], 2);
            Items[29].ItemQuantities.Add(Items[9], 1);
            Items[29].ItemQuantities.Add(Items[15], 1);
            Items[29].ItemQuantities.Add(Items[20], 1);

            // 30
            Items[30].ItemQuantities.Add(Items[24], 2);
            Items[30].ItemQuantities.Add(Items[25], 2);
            Items[30].ItemQuantities.Add(Items[6], 1);
            Items[30].ItemQuantities.Add(Items[12], 1);
            Items[30].ItemQuantities.Add(Items[29], 1);

            // 31
            Items[31].ItemQuantities.Add(Items[24], 1);
            Items[31].ItemQuantities.Add(Items[27], 1);
            Items[31].ItemQuantities.Add(Items[16], 1);
            Items[31].ItemQuantities.Add(Items[17], 1);
            Items[31].ItemQuantities.Add(Items[30], 1);

            // 32 - 48: Procurement parts

            // 49
            Items[49].ItemQuantities.Add(Items[24], 2);
            Items[49].ItemQuantities.Add(Items[25], 2);
            Items[49].ItemQuantities.Add(Items[7], 1);
            Items[49].ItemQuantities.Add(Items[13], 1);
            Items[49].ItemQuantities.Add(Items[18], 1);

            // 50
            Items[50].ItemQuantities.Add(Items[24], 2);
            Items[50].ItemQuantities.Add(Items[25], 2);
            Items[50].ItemQuantities.Add(Items[4], 1);
            Items[50].ItemQuantities.Add(Items[10], 1);
            Items[50].ItemQuantities.Add(Items[49], 1);

            // 51
            Items[51].ItemQuantities.Add(Items[24], 1);
            Items[51].ItemQuantities.Add(Items[27], 1);
            Items[51].ItemQuantities.Add(Items[16], 1);
            Items[51].ItemQuantities.Add(Items[17], 1);
            Items[51].ItemQuantities.Add(Items[50], 1);

            // 52 - 54: Procurement parts

            // 54
            Items[54].ItemQuantities.Add(Items[24], 2);
            Items[54].ItemQuantities.Add(Items[25], 2);
            Items[54].ItemQuantities.Add(Items[8], 1);
            Items[54].ItemQuantities.Add(Items[14], 1);
            Items[54].ItemQuantities.Add(Items[19], 1);

            // 55
            Items[55].ItemQuantities.Add(Items[24], 2);
            Items[55].ItemQuantities.Add(Items[25], 2);
            Items[55].ItemQuantities.Add(Items[5], 1);
            Items[55].ItemQuantities.Add(Items[11], 1);
            Items[55].ItemQuantities.Add(Items[54], 1);

            // 56
            Items[56].ItemQuantities.Add(Items[24], 1);
            Items[56].ItemQuantities.Add(Items[27], 1);
            Items[56].ItemQuantities.Add(Items[16], 1);
            Items[56].ItemQuantities.Add(Items[17], 1);
            Items[56].ItemQuantities.Add(Items[55], 1);
